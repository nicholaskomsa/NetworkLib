...
public:
	...
	void createOutputStream(NetworkLib::Tensor::ConstView floatSpaceView, const std::string_view fileName = "gpt2.animation") {
		...
		//write header
		std::size_t floatCount = mSourceFloatSpaceView.size();
	...
	void startReadingWindow(FloatSpaceConvert::FloatSpaceDimensions frameRect, std::size_t frameWidth) {
		...
		//images are of entire float space
